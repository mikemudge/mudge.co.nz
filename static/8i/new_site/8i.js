...
// TODO should add templates here?
...
.config(function($routeProvider, $locationProvider) {
  ...
  $routeProvider
    .when('/', {
      templateUrl: '/static/8i/new_site/main.html',
      title: '8i | Home'
    })
    .when('/experience', {
      templateUrl: '/static/8i/new_site/experience.html',
      title: '8i | Experience'
    })
    .when('/experience_web', {
      templateUrl: '/static/8i/new_site/experience_web.html',
      title: '8i | Experience'
    })
    .when('/create', {
      templateUrl: '/static/8i/new_site/create.html',
      title: '8i | Create'
    })
    .when('/jobs', {
      templateUrl: '/static/8i/new_site/jobs.html?v=1',
      title: '8i | Careers'
    })
    .when('/ads', {
       templateUrl: '/static/8i/new_site/ads.html',
       title: '8i | Ads'
    })
    .when('/holo', {
      templateUrl: '/static/8i/new_site/holo.html?v=1',
      title: '8i | Holo App'
    })
    .when('/holo/beta', {
      templateUrl: '/static/8i/new_site/holo_beta.html',
      title: '8i | Holo Beta'
    })
    .when('/install', {
      templateUrl: '/static/8i/new_site/install.html',
      title: '8i | Install'
    })
    .when('/about', {
      templateUrl: '/static/8i/new_site/team.html?v=2',
      title: '8i | Team'
    })
    .when('/privacy', {
      templateUrl: '/static/8i/new_site/privacy.html',
      title: '8i | Privacy Policy'
    })
    .when('/terms', {
      templateUrl: '/static/8i/new_site/terms.html',
    ...
    .otherwise({
      templateUrl: '/static/8i/new_site/404.html',
