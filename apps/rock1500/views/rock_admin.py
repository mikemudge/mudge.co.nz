...
class RockSongView(BaseView):
    ...
    column_searchable_list = ['title', 'rankThisYear', 'rank2018', 'rank2017', 'rank2016', 'rank2015', 'rank2014', 'artist.name', 'album.name']

    column_filters = ['rankThisYear', 'rank2018', 'rank2017', 'rank2016', 'rank2015', 'rank2014']
